...
app.post('/search', (req, res) => {
    ...
    let movieUrl = `https://api.themoviedb.org/3/search/movie?query=${userMovieTitle}&api_key=7ed7e01398b42a060e8057d0902ca104`;
    let genresUrl = 'https://api.themoviedb.org/3/genre/movie/list?api_key=7ed7e01398b42a060e8057d0902ca104&language=en-US';
